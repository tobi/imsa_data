...
SELECT
    ...
    laps.class,
    laps.driver_name,
    -- driver_id is already resolved in 020; re-resolving the display name here
    -- is a second pass over the alias graph and can land on a different id
    laps.driver_id,
    laps.lap,
    laps.lap_time,
    laps.lap_time_s1,
    ...
    laps.s2_meters,
    laps.s3_meters,
    laps.has_microsectors,
    laps.microsectors_json,
